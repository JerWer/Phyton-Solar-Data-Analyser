...
#        self.EQEDBbut.pack(side=tk.RIGHT)
        ...
        self.stichingbut = Button(frame21315, text="StitchEQEs",
                            command = self.StitchEQE)
        self.stichingbut.pack(side=tk.LEFT)
...
#            print("there is an exception...check legend maybe...")
    ...
    def SelectData(self):
        ...
        self.lstbox = Listbox(frame, listvariable=valores, selectmode=MULTIPLE, width=40, yscrollcommand=scrollbar.set, exportselection=0)
